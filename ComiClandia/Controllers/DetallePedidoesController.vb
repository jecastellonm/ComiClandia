...
Namespace Controllers
  Public Class DetallePedidoesController
    ...
    Function Create(<Bind(Include:="DetallePedidoId,IdProducto,IdPedido,Cantidad,TotalDetalleP,FechaAdiciDetaPedido,FechaModifiDetaPedido,Observaciones,Activo")> ByVal detallePedido As DetallePedido) As ActionResult
      Dim ValorProducto As Integer
      ValorProducto = db.Producto.Find(detallePedido.IdProducto).Valor
      detallePedido.TotalDetalleP = detallePedido.Cantidad * ValorProducto
    ...
    <HttpPost()>
    <ValidateAntiForgeryToken()>
    Function Edit(<Bind(Include:="DetallePedidoId,IdProducto,IdPedido,Cantidad,TotalDetalleP,FechaAdiciDetaPedido,FechaModifiDetaPedido,Observaciones,Activo")> ByVal detallePedido As DetallePedido) As ActionResult
      Dim ValorProducto As Integer
      ValorProducto = db.Producto.Find(detallePedido.IdProducto).Valor
      detallePedido.TotalDetalleP = detallePedido.Cantidad * ValorProducto
